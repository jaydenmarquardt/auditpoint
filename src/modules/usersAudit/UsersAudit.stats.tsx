...
export const UsersAuditStats: React.FC<{ view: UsersAuditView; config: UsersAuditConfig }> = ({
  ...
  return (
    ...
    >
      <StatTile label={UsersAuditContent.stats.people} value={formatNumber(totals.people)} info={UsersAuditContent.tileInfo.people} />
      <StatTile label={UsersAuditContent.stats.users} value={formatNumber(totals.users)} info={UsersAuditContent.tileInfo.users} />
      <StatTile
      ...
      />
      <StatTile label={UsersAuditContent.stats.system} value={formatNumber(totals.system)} info={UsersAuditContent.tileInfo.system} />
      <StatTile
