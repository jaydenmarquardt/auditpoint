...
export const ListsByInheritanceCard: React.FC<{ view: PermissionsAuditView }> = ({ view }) => (
  <ChartCard
    title={PermissionsAuditContent.charts.inheritance}
    info={PermissionsAuditContent.cardInfo.inheritance}
    defaultChart="donut"
    charts={["donut", "hbar", "stacked"]}
    centreLabel={formatNumber(view.totals.lists)}
    points={view.inheritanceSplit}
  />
);
