...
export interface IndexingAuditView {
  ...
  coverageByList: { label: string; value: number }[];
  indexedByList: { label: string; value: number }[];
  crawlSplit: { label: string; value: number }[];
  itemSplit: { label: string; value: number }[];
