...
import { appStore, setFullscreen, toggleFullscreen, useAppState } from "../state/App.store";
...
export function restoreFullscreenPreference() {
    setFullscreen(readLocal(STORAGE_KEY, false));
}
export function useFullscreen(allowed) {
