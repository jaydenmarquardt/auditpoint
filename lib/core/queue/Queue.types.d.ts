export type TaskStatus = "queued" | "waiting" | "running" | "throttled" | "paused" | "succeeded" | "failed" | "cancelled";
...
export type TaskRunner<TPayload = unknown, TResult = unknown> = (payload: TPayload, controls: TaskControls) => Promise<TResult>;
