...
import { clearReportConfig, clearRun, openEnvelope, reportConfig, saveReportConfig, startReport, useReportRun, } from "./Report.store";
...
export function useReport(definition) {
    ...
    const [config, setConfig] = useState(() => reportConfig(definition));
    ...
    return {
        ...
        running: (envelope === null || envelope === void 0 ? void 0 : envelope.status) !== "complete" &&
            (envelope === null || envelope === void 0 ? void 0 : envelope.status) !== "failed" &&
        ...
        resetConfig: useCallback(() => {
            ...
            setConfig(reportConfig(definition));
        }, [definition]),
        resumeSaved,
