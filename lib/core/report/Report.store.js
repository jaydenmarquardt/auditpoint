...
export function reportConfig(definition) {
    var _a;
    return Object.assign(Object.assign(Object.assign({}, definition.defaultConfig), ((_a = hostConfigDefaults.get(definition.kind)) !== null && _a !== void 0 ? _a : {})), mappedConfig(definition.kind, getSettings()));
}
