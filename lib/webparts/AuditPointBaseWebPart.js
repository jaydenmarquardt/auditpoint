...
export class AuditPointBaseWebPart extends BaseClientSideWebPart {
    ...
    onInit() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            this.host = (_a = (yield this.setup())) !== null && _a !== void 0 ? _a : {};
            this.configure();
    ...
    configure() {
        ...
        const settings = initSettings(this.properties.settingsJson, { url: this.context.pageContext.web.absoluteUrl, title: this.context.pageContext.web.title }, Object.assign(Object.assign({}, this.host.settings), { disabledModules: (_b = (_a = this.host.settings) === null || _a === void 0 ? void 0 : _a.disabledModules) !== null && _b !== void 0 ? _b : this.host.disabledModules }));
