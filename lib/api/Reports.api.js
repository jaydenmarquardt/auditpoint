...
export function runStatusOf(status, updatedIso) {
    if (status !== "running")
        return status;
    ...
    return {
        ...
        index() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    return JSON.parse(text).map((entry) => (Object.assign(Object.assign({}, entry), { status: runStatusOf(entry.status, entry.updatedIso) })));
                }
                catch (_a) {
                    return [];
                }
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return files
                    ...
                    return {
                        ...
                        modified: (_d = entry === null || entry === void 0 ? void 0 : entry.updatedIso) !== null && _d !== void 0 ? _d : file.TimeLastModified,
                        sizeBytes: Number((_e = file.Length) !== null && _e !== void 0 ? _e : 0),
                        createdBy: (_f = entry === null || entry === void 0 ? void 0 : entry.createdBy) !== null && _f !== void 0 ? _f : "",
                        createdByLogin: (_g = entry === null || entry === void 0 ? void 0 : entry.createdByLogin) !== null && _g !== void 0 ? _g : "",
                    };
                })
        ...
        read(serverRelativeUrl) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return Object.assign(Object.assign({}, envelope), { status: runStatusOf(envelope.status, envelope.updatedIso) });
            });
        },
        save(envelope) {
            return __awaiter(this, void 0, void 0, function* () {
