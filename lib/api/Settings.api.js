...
function fromFile(file, hostSite) {
    ...
    return {
        ...
        fields: Object.assign(Object.assign({}, NO_FIELDS), ((_e = file.fields) !== null && _e !== void 0 ? _e : {})),
        legacyUrls: ((_f = file.legacyUrls) !== null && _f !== void 0 ? _f : []).map((host) => host.trim()).filter((host) => host.length > 0),
    };
}
