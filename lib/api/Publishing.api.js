...
function fields(webUrl, list) {
    return __awaiter(this, void 0, void 0, function* () {
        return (yield throttled(() => getSp(webUrl).web.lists.getById(list.id).fields.select("InternalName", "TypeAsString", "Hidden")(), { label: "Publishing.fields" }));
    });
}
export function Publishing(webUrl) {
    ...
    return {
        fieldNames(list) {
            return __awaiter(this, void 0, void 0, function* () {
                return (yield fields(webUrl, list)).map((field) => field.InternalName);
            });
        },
        contentColumns(list) {
            return __awaiter(this, void 0, void 0, function* () {
                return (yield fields(webUrl, list))
