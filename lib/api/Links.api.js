    ...
    return {
        ...
        fromHtml(html, context) {
            ...
            return Array.from(document.querySelectorAll("a")).map((anchor) => {
                var _a, _b;
                return placement(((_a = anchor.getAttribute("href")) !== null && _a !== void 0 ? _a : "").trim(), ((_b = anchor.textContent) !== null && _b !== void 0 ? _b : "").replace(/\s+/g, " ").trim(), context, origin);
            });
        },
        fromUrl(url, text, context) {
                ...
                if (typeof value === "string") {
                    ...
                    if (HTML_VALUE.test(text)) {
                        new DOMParser()
                            ...
                            if (href)
                                found.set(`${href}|${label}`, placement(href, label, context, origin));
                        });
                        return;
                    }
...
export function placement(url, text, context, origin) {
