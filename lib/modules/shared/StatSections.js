...
export const StatSections = ({ sections }) => (React.createElement("div", { style: { display: "grid", gap: Theme.tokens.space.lg, width: "100%", minWidth: 0 } }, sections.map((section) => (React.createElement(StatGrid, { key: section.title, title: section.title, tiles: section.tiles, minWidth: 180 })))));
