    ...
    const columns = [
        {
            ...
            render: (entry) => (React.createElement("div", { style: { minWidth: 0 } },
                React.createElement("div", { style: { fontWeight: 600 } }, formatDateTime(entry.updatedIso)),
        ...
        },
        {
            ...
            render: (entry) => (React.createElement("div", { style: { display: "flex", gap: 4 } },
                React.createElement(Button, { label: "Open", variant: "subtle", iconName: "OpenFile", disabled: busy, onClick: () => onOpen(urlOf(entry)) }),
                entry.status !== "complete" && owns(entry) && (React.createElement(Button, { label: "Resume", variant: "subtle", iconName: "Play", disabled: busy, onClick: () => onResume(urlOf(entry)) })),
