...
export const OverviewTab = ({ view, config, hasData, onRun, comparison, comparisonCards, previous }) => {
    if (!hasData) {
    ...
    return (React.createElement("div", { style: { display: "grid", gap: Theme.tokens.space.lg, minWidth: 0 } },
        comparison,
        React.createElement(LinkAuditStats, { view: view, config: config, previous: previous }),
