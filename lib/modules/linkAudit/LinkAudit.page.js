            ...
            React.createElement(Tabs, { ariaLabel: LinkAuditContent.title, selectedKey: tab, onChange: setTab, items: [
                    {
                        ...
                        content: (React.createElement(OverviewTab, { view: view, config: (_f = (_e = controller.envelope) === null || _e === void 0 ? void 0 : _e.config) !== null && _f !== void 0 ? _f : controller.config, hasData: hasData, onRun: () => setConfigOpen(true) })),
                    },
                    {
                        key: "references",
