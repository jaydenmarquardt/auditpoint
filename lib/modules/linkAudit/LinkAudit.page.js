...
import { statSections } from "./LinkAudit.stats";
            ...
            React.createElement(Tabs, { ariaLabel: LinkAuditContent.title, selectedKey: tab, onChange: setTab, items: [
                    {
                        ...
                        content: (React.createElement(OverviewTab, { view: view, config: (_f = (_e = controller.envelope) === null || _e === void 0 ? void 0 : _e.config) !== null && _f !== void 0 ? _f : controller.config, hasData: hasData, onRun: () => setConfigOpen(true), previous: previous, comparisonCards: previous ? (React.createElement(ComparisonCards, { sections: statSections(view, (_h = (_g = controller.envelope) === null || _g === void 0 ? void 0 : _g.config) !== null && _h !== void 0 ? _h : controller.config).map((section, index) => {
                                    var _a, _b, _c;
                                    return (Object.assign(Object.assign({}, section), { tiles: compareTiles(section.tiles, (_c = statSections(previous, (_b = (_a = controller.envelope) === null || _a === void 0 ? void 0 : _a.config) !== null && _b !== void 0 ? _b : controller.config)[index]) === null || _c === void 0 ? void 0 : _c.tiles) }));
                                }) })) : undefined, comparison: hasData ? (React.createElement(ComparisonBar, { kind: linkAuditReport.kind, currentId: (_j = controller.envelope) === null || _j === void 0 ? void 0 : _j.id, onChange: (next) => setPreviousData(next) })) : undefined })),
                    },
                    {
                        key: "references",
                    ...
                    },
                    {
                        ...
                        content: (React.createElement(UntestedTab, { usages: view.untested, checked: Boolean(((_l = (_k = controller.envelope) === null || _k === void 0 ? void 0 : _k.config) !== null && _l !== void 0 ? _l : controller.config).checkBrokenLinks) })),
                    },
                    {
                        key: "external",
