 ...
 */
export function statSections(view) {
...
export const LinkAuditStats = ({ view }) => (React.createElement("div", { style: { display: "grid", gap: Theme.tokens.space.lg, width: "100%", minWidth: 0 } }, statSections(view).map((section) => (React.createElement(StatGrid, { key: section.key, title: section.title, tiles: section.tiles, minWidth: 180 })))));
