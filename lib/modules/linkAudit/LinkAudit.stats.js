...
export const LinkAuditStats = ({ view, config, previous }) => {
    ...
    return (React.createElement("div", { style: { display: "grid", gap: Theme.tokens.space.lg, width: "100%", minWidth: 0 } }, statSections(view, config).map((section, index) => {
        var _a;
        return (React.createElement(StatGrid, { key: section.key, title: section.title, tiles: compareTiles(section.tiles, (_a = before === null || before === void 0 ? void 0 : before[index]) === null || _a === void 0 ? void 0 : _a.tiles), minWidth: 180 }));
    })));
};
