...
export function indexReferences(references) {
    ...
    references.forEach((source) => {
        ...
        ((_a = source.outgoing) !== null && _a !== void 0 ? _a : []).forEach((link) => {
            ...
            const targets = (_b = byUrl.get(`${(_a = link.url) !== null && _a !== void 0 ? _a : ""}`.toLowerCase())) !== null && _b !== void 0 ? _b : byUrl.get(stripUrlSuffix(link.url).toLowerCase());
...
export function buildView(data, origin) {
    ...
    return {
        ...
        bySource: ["content", "webpart", "navigation", "document"]
            .map((source) => ({
