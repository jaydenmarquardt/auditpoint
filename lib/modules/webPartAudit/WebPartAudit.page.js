            ...
            React.createElement(Tabs, { ariaLabel: WebPartAuditContent.title, selectedKey: tab, onChange: setTab, items: [
                    {
                        ...
                        content: React.createElement(OverviewTab, { view: view, hasData: hasData, onRun: () => setConfigOpen(true), previousTiles: previousTiles, comparison: hasData ? (React.createElement(ComparisonBar, { kind: webPartAuditReport.kind, currentId: (_d = controller.envelope) === null || _d === void 0 ? void 0 : _d.id, onChange: (next) => setPreviousData(next) })) : undefined }),
                    },
                    {
                        key: "types",
