...
const PermissionsAuditPage = () => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(ReportRunPanel, { title: permissionsAuditReport.title, controller: controller, definition: permissionsAuditReport, onBack: controller.envelope ? controller.clear : undefined, backLabel: PermissionsAuditContent.backToRuns, configOpen: configOpen, onConfigOpenChange: setConfigOpen, configPanel: React.createElement(ReportConfigPanel, { bare: true, title: PermissionsAuditContent.configTitle, definition: permissionsAuditReport, config: controller.config, onChange: controller.setConfig }), extraControls: hasData ? (React.createElement(Button, { label: PermissionsAuditContent.exportCsv, iconName: "ExcelDocument", onClick: () => exportPermissionsAudit(data) })) : undefined, runLabel: {
