...
export const PermissionsAuditStats = ({ view, config }) => {
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement(StatTile, { iconName: "People", label: PermissionsAuditContent.stats.members, value: config.readGroupMembers ? formatNumber(totals.members) : "-", info: PermissionsAuditContent.tileInfo.members }),
        React.createElement(StatTile, { iconName: "FieldEmpty", label: PermissionsAuditContent.stats.empty, value: config.readGroupMembers ? formatNumber(totals.emptyGroups) : "-", info: PermissionsAuditContent.tileInfo.empty }),
        ...
        React.createElement(StatTile, { iconName: "BranchFork2", label: PermissionsAuditContent.stats.itemBreaks, value: config.checkItemBreaks ? formatNumber(totals.itemBreaks) : "-", hint: config.checkItemBreaks ? `${formatNumber(totals.itemsChecked)} sampled` : undefined, info: PermissionsAuditContent.tileInfo.itemBreaks })));
};
