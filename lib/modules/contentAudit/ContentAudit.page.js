            ...
            React.createElement(Tabs, { ariaLabel: ContentAuditContent.title, selectedKey: tab, onChange: setTab, items: [
                    {
                        ...
                        content: React.createElement(OverviewTab, { view: view, hasData: hasData, onRun: () => setConfigOpen(true), previousTiles: previousTiles, comparisonCards: previousTiles ? (React.createElement(ComparisonCards, { sections: [{ title: "", tiles: compareTiles(statTiles(view), previousTiles) }] })) : undefined, comparison: hasData ? (React.createElement(ComparisonBar, { kind: contentAuditReport.kind, currentId: (_f = controller.envelope) === null || _f === void 0 ? void 0 : _f.id, onChange: (next) => setPreviousData(next) })) : undefined }),
                    },
                    {
                        key: "entries",
