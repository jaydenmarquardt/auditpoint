...
import { analyticsAuditReport } from "./analyticsAudit/AnalyticsAudit.report";
export const MODULES = [
    ...
    },
    {
        ...
        label: "Analytics",
        version: "1.0.0",
        description: "Views, unique viewers and time spent for every page and file, by day, folder, area and file type.",
        iconName: "BarChartVertical",
        group: "audits",
        report: analyticsAuditReport,
        load: () => import(/* webpackChunkName: "app-analytics-audit" */ "@/modules/analyticsAudit/AnalyticsAudit.page"),
    },
    {
        key: "search-tool",
        label: "Search",
...
export function setHiddenRoutes(keys) {
    hiddenRoutes.clear();
    keys.forEach((key) => hiddenRoutes.add(key));
}
export function isRouteVisible(key) {
