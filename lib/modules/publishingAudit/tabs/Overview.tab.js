...
export const OverviewTab = ({ view, config, hasData, onRun, comparison, previousTiles }) => {
    if (!hasData) {
    ...
    return (React.createElement("div", { style: { display: "grid", gap: Theme.tokens.space.lg, minWidth: 0 } },
        ...
        config.readPopularity && React.createElement(Notice, { tone: "info", message: PublishingAuditContent.popularityNote }),
