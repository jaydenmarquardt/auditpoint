...
export const PublishingAuditStats = ({ view, config, previousTiles }) => (React.createElement(StatSections, { sections: sectionsFrom(compareTiles(statTiles(view, config), previousTiles), STAT_SECTIONS) }));
