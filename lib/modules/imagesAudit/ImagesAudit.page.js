            ...
            React.createElement(Tabs, { ariaLabel: ImagesAuditContent.title, selectedKey: tab, onChange: setTab, items: [
                    {
                        ...
                        content: React.createElement(OverviewTab, { view: view, hasData: hasData, onRun: () => setConfigOpen(true), previousTiles: previousTiles, comparison: hasData ? (React.createElement(ComparisonBar, { kind: imagesAuditReport.kind, currentId: (_f = controller.envelope) === null || _f === void 0 ? void 0 : _f.id, onChange: (next) => setPreviousData(next) })) : undefined }),
                    },
                    {
                        key: "files",
