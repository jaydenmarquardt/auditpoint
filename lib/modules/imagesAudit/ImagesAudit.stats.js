...
export const ImagesAuditStats = ({ view, previousTiles }) => (React.createElement(StatSections, { sections: sectionsFrom(compareTiles(statTiles(view), previousTiles), STAT_SECTIONS) }));
