...
export const fileColumns = [
    ...
    },
    {
        ...
        render: (file) => (React.createElement("span", { title: file.duplicateOf.join("\n") },
            React.createElement(Badge, { label: ImagesAuditContent.duplicates[file.duplicateConfidence], tone: DUPLICATE_TONE[file.duplicateConfidence], showIcon: false }))),
    },
    {
        key: "flags",
