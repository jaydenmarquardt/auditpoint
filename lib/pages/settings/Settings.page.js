...
const SettingsPage = () => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { style: { display: "grid", gap: Theme.tokens.space.md } },
            ...
            React.createElement(Card, { title: SettingsContent.mapping.title, subtitle: SettingsContent.mapping.description },
                React.createElement(FieldRow, null,
                    React.createElement(TextField, { label: SettingsContent.mapping.organisationalUnit, description: SettingsContent.mapping.organisationalUnitHint, value: draft.fields.organisationalUnit, onChange: (value) => set("fields", Object.assign(Object.assign({}, draft.fields), { organisationalUnit: value })), disabled: !editMode }),
                    React.createElement(TextField, { label: SettingsContent.mapping.organisationalUnitList, description: SettingsContent.mapping.organisationalUnitListHint, value: draft.fields.organisationalUnitList, onChange: (value) => set("fields", Object.assign(Object.assign({}, draft.fields), { organisationalUnitList: value })), disabled: !editMode })),
                React.createElement(FieldRow, null,
                    React.createElement(TextField, { label: SettingsContent.mapping.publishDate, value: draft.fields.publishDate, onChange: (value) => set("fields", Object.assign(Object.assign({}, draft.fields), { publishDate: value })), disabled: !editMode }),
                    React.createElement(TextField, { label: SettingsContent.mapping.reviewDate, value: draft.fields.reviewDate, onChange: (value) => set("fields", Object.assign(Object.assign({}, draft.fields), { reviewDate: value })), disabled: !editMode }),
                    React.createElement(TextField, { label: SettingsContent.mapping.expiryDate, value: draft.fields.expiryDate, onChange: (value) => set("fields", Object.assign(Object.assign({}, draft.fields), { expiryDate: value })), disabled: !editMode })),
                React.createElement(TextArea, { label: SettingsContent.mapping.htmlFields, description: SettingsContent.mapping.htmlFieldsHint, value: draft.fields.htmlFields.join("\n"), onChange: (value) => set("fields", Object.assign(Object.assign({}, draft.fields), { htmlFields: parseList(value) })), rows: 3, disabled: !editMode })),
            React.createElement(Card, { title: SettingsContent.legacy.title, subtitle: SettingsContent.legacy.description },
                React.createElement(TextArea, { label: SettingsContent.legacy.label, value: draft.legacyUrls.join("\n"), onChange: (value) => set("legacyUrls", parseList(value)), rows: 3, disabled: !editMode })),
