        ...
        ["audits", "tools", "system"].map((group) => {
            ...
            return (React.createElement("section", { key: group, style: { marginBottom: Tokens.space.lg } },
                ...
                React.createElement("div", { style: {
                    ...
                    return (React.createElement(Card, { key: route.key, title: route.label, subtitle: route.description, onClick: () => navigate(locked ? "settings" : route.key), actions: React.createElement("span", { "aria-hidden": "true", style: {
                                display: "inline-flex",
                                alignItems: "center",
                        ...
                        React.createElement("span", { style: { color: locked ? Tokens.colour.textMuted : Tokens.colour.accent, fontWeight: 600 } }, locked ? "Configure to enable" : "Open")));
                }))));
        })));
};
