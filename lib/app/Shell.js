...
export const Shell = () => {
    ...
    return (React.createElement("div", { className: "auditpoint-root", style: AppStyles.shell(fullscreen) },
        React.createElement(Topbar, { sidebarOpen: sidebarOpen, onToggleSidebar: toggleSidebar, fullscreen: fullscreen, onToggleFullscreen: toggleFullscreenView, fullscreenAllowed: !editMode, activeTaskCount: activeTaskCount, onOpenQueue: toggleQueueBar, userName: access.user.title, siteTitle: webTitle }),
