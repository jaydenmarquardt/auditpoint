...
const Delta = ({ current, previous }) => {
    ...
    return (React.createElement("div", { style: { marginTop: 4, display: "flex", alignItems: "center", gap: 4, fontSize: Tokens.font.sm } },
        React.createElement("i", { className: `ms-Icon ms-Icon--${difference === 0 ? "Remove" : difference > 0 ? "CaretSolidUp" : "CaretSolidDown"}`, "aria-hidden": "true", style: { color: palette.fg, fontSize: 10 } }),
        React.createElement("span", { style: { color: palette.fg, fontWeight: 600 } },
            difference > 0 ? "+" : "",
