...
export const StatGrid = ({ tiles, minWidth = 190, title }) => (React.createElement("section", { style: { minWidth: 0, width: "100%" } },
    ...
    React.createElement("div", { style: {
            ...
            width: "100%",
            minWidth: 0,
        } }, tiles.map((tile) => (React.createElement(StatTile, { key: tile.key, width: minWidth, label: tile.label, value: tile.value, hint: tile.hint, info: tile.info, tone: tile.tone, badge: tile.badge, iconName: tile.iconName }))))));
