...
export const StackedBar = ({ ariaLabel, title, segments, height = 16, valueFormatter = (value) => value.toLocaleString(), emptyLabel, }) => {
    ...
    return (React.createElement(ChartFrame, { title: title, ariaLabel: ariaLabel },
        React.createElement("div", { ref: ref, style: { width: "100%", minWidth: 0 } },
            React.createElement(StackedBarChart, { data: data, width: width, barHeight: height, hideDenominator: true, ignoreFixStyle: true }))));
};
